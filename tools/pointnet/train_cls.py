...
def main(args):
    ...
    shutil.copy(os.path.join(ROOT_DIR, 'model', '%s.py' % args.model), str(exp_dir))
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        with torch.no_grad():
            instance_acc, class_acc = test(classifier.eval(), testDataLoader, device, num_class=num_class)
